...
public class AffaireDetailsDialog extends JDialog {
    ...
    try (Connection conn = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWORD);
        ...
        try (ResultSet rs = pstmt.executeQuery()) {
            ...
            while (rs.next()) {
                ...
                // Bouton Dossier individuel pour chaque opposant (Clic simple fluide)
                ...
                // Un seul clic simple pour ouvrir la gestion des documents (qui gère l'affichage ou l'ajout)
    ...
    // Récupération des documents de l'opposant depuis la base de données
    ...
    // Si des documents existent, on demande si l'utilisateur veut voir ou rajouter
    ...
    if (userSelection == JFileChooser.APPROVE_OPTION) {
        ...
        try {
            ...
            // Enregistrement du chemin et liaison avec l'opposant en base de données
